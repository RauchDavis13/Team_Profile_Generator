    ...
    { 
        ...
        validate: school => {
          if (school) {
            ...
            console.log('Please enter the school you went to!');
            return false;
          }
        }
    },
...
const addManager = () => {
  ...
  .then(answers => {
    const manager = new Manager(answers.name, answers.id, answers.email, answers.role, answers.officeNum)
...
const addEngineer = () => {
  ...
  .then(answers => {
    const engineer = new Engineer(answers.name, answers.id, answers.email, answers.roleanswers.gitHub)
    employeeArray.push(Manager);
    // addTeamMember();
    })
};
